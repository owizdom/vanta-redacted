...
async function main(): Promise<void> {
  ...
  const r = await postJson<{
    ...
    // polygon-rpc.com returns 401 from the TEE node's IP; llamarpc
    // mirrors mainnet without auth gate. Both whitelisted in egress.
    chain: { chainId: 137, rpcUrl: "https://polygon-bor-rpc.publicnode.com" },
  });
